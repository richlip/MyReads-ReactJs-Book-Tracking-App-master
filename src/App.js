    ...
    **/
    render() {
        ...
        return ( < div className="app" > < Route exact path='/'
            render={
                () => ( < div className="list-books" > < div className="list-books-title" > < h1 > MyReads < /h1> < /div> < div className="list-books-content" > < div > < Bookshelf title='Currently Reading'
                    books={
                    ...
                    /> < /div> < /div> < div className="open-search" > < Link to='/SearchBook' > Add a book < /Link> < /div> < /div>)
            }
            /> < Route path='/SearchBook'
            render={
                ({
                    history
                }) => ( < SearchBook onShelfSelect={
                        (event) => {
